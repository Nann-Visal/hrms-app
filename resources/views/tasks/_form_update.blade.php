<div class="card p-3 my-3" style="background-color: #f4f5f7;">
    <div class="row">
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('task_name') is-invalid @enderror" value="{{old('task_name',$task->task_name)}}" type="text" placeholder="project name . . ." name="task_name" id="task_name">
            @error('task_name')
        ...
        <div class="col-xl-4 my-2">
            ...
            <select class="form-select form-select-lg @error('project_id') is-invalid @enderror" name="project_id" id="project_id">
                @foreach ( $projects as $id => $project)
                    <option value="{{$id}}" @selected($id==old('project_id',$task->project_id))>{{$project}}</option>
                @endforeach
            </select>
            @error('project_id')
                <div class="invalid-feedback">
        ...
        <div class="col-xl-4 my-2">
            ...
            <select class="form-select form-select-lg @error('employee_id') is-invalid @enderror" name="employee_id" id="employee_id">
                @foreach ( $employees as $id => $employee)
                    <option value="{{$id}}" @selected($id==old('employee_id',$task->employee_id)) >{{$employee}}</option>
                @endforeach
            </select>
            @error('employee_id')
                <div class="invalid-feedback">
        ...
        <div class="col-xl-4 my-2">
            ...
            <select class="form-select form-select-lg @error('task_status') is-invalid @enderror" name="task_status" id="task_status">
                <option value="{{old('task_status',$task->task_status)}}" selected>{{$task->task_status}}</option>
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('start_date') is-invalid @enderror" value="{{old('start_date',$task->start_date)}}" type="date"  name="start_date" id="start_date">
            @error('start_date')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('end_date') is-invalid @enderror" value="{{old('end_date',$task->end_date)}}" type="date"  name="end_date" id="end_date">
            @error('end_date')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-8 my-2">
            ...
            <textarea  rows="4" class="form-control form-control-lg @error('describtions') is-invalid @enderror" name="describtions" id="describtions" placeholder="describtion . . .">{{old('describtions',$task->describtions)}}</textarea>
            @error('describtions')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
