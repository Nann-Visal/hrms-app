<div class="card p-3 my-3" style="background-color: #f4f5f7;">
    <div class="row">
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('hour') is-invalid @enderror" value="{{old('hour')}}" type="number" placeholder="hour . . ." name="hour" id="hour">
            @error('hour')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('late_time') is-invalid @enderror" value="{{old('late_time')}}" type="number"  placeholder="00 menute " name="late_time" id="late_time">
            @error('late_time')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
