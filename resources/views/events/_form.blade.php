<div class="card p-3 my-3" style="background-color: #f4f5f7;">
    <div class="row">
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('event_name') is-invalid @enderror" value="{{old('event_name')}}" type="text" placeholder="event name . . ."  name="event_name" id="event_name">
            @error('event_name')
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('start_time') is-invalid @enderror" value="{{old('start_time')}}" type="time" placeholder="start_time . . ." name="start_time" id="start_time">
            @error('start_time')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('end_time') is-invalid @enderror" value="{{old('end_time')}}" type="time" placeholder="end_time . . ." name="end_time" id="end_time">
            @error('end_time')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-4 my-2">
            ...
            <textarea  rows="1" class="form-control form-control-lg @error('subject') is-invalid @enderror" value="{{old('subject')}}" name="subject" id="subject" placeholder="subject . . ."></textarea>
            @error('subject')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
        ...
        <div class="col-xl-8 my-2">
            ...
            <textarea  rows="4" class="form-control form-control-lg @error('descibtion') is-invalid @enderror" value="{{old('descibtion')}}" name="descibtion" id="descibtion" placeholder="descibtions . . ."></textarea>
            @error('descibtion')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
