    ...
    <div class="row">
        ...
        <div class="col-xl-4 my-2">
            ...
            <select class="form-select form-select-lg @error('position') is-invalid @enderror" name="position" id="position">
                <option value="{{old('positions')}}" selected>{{old('position')}}</option>
        ...
        <div class="col-xl-4 my-2">
            ...
            <input class="form-control form-control-lg @error('start_date') is-invalid @enderror" type="date" value="{{old('start_date')}}" name="start_date" id="start_date">
            @error('start_date')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
